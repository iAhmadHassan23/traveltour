...
<div class="container mx-auto max-w-screen-xl px-2">
    ...
    <div class="block sm:hidden" id="categories">
            ...
            <div class="swiper1 swiper1-initialized swiper1-horizontal swiper1-backface-hidden">
                <div class="swiper-wrapper customSwipper" style="transform: translate3d(0px, 0px, 0px);">
                    <div class="swiper1-slide swiper1-slide-active w-auto" style="margin-right: 16px;">
                        <button class="min-w-28 px-1 py-2 text-center border-b-4 text-black transition duration-150 hover:opacity-100 hover:border-b-yellow-400  border-b-yellow-400 opacity-100">
                    ...
                    <div class="swiper1-slide swiper1-slide-next w-auto" style="margin-right: 16px;">
                        <button class="min-w-28 px-1 py-2 text-center border-b-4 text-black transition duration-150 hover:opacity-100 hover:border-b-yellow-400  border-transparent opacity-60">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 gap-y-12 mt-4">
            <div>
                <a href="/honeymoon-trips/bali-honeymoon-7-days-6-nights-tour-package/"
                    data-discover="true">
                    <div class="relative">
                        <img src="https://cdn.enjoykarado.com/packages/66f6d01483d96.webp" alt="Bali Honeymoon 7 Days 6 Nights Tour Package"
                    ...
                    <div class="flex place-items-center mt-1 overflow-hidden h-14">
                        <h2 class="text-lg font-medium line-clamp-2">
                            Bali Honeymoon 7 Days 6 Nights Tour Package
                        </h2>
                    </div>
            ...
            <div>
                <a href="/honeymoon-trips/andaman-honeymoon-5-days-4-nights-tour-package/"
                    data-discover="true">
                    <div class="relative">
                        <img src="https://cdn.enjoykarado.com/packages/67028a9d41fa7.webp" alt="Andaman Honeymoon 5 Days/ 4 Nights Tour Package"
                            class="w-full aspect-[6/7] object-cover rounded-3xl mb-2">
                        <div class="absolute top-3 left-3 lg:top-2 lg:left-2 text-base lg:text-xs z-10 backdrop-blur">
                            <div class="flex gap-2 place-items-center bg-black/30 text-white px-2 py-1 rounded-3xl">
                                <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24"
                    ...
                    <div class="flex place-items-center mt-1 overflow-hidden h-14">
                        <h2 class="text-lg font-medium line-clamp-2">
                            Andaman Honeymoon 5 Days/ 4 Nights Tour Package
                        </h2>
                    </div>
                    <div class="flex place-items-center text-sm font-medium mt-1 text-gray-500">
                        <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 16 16"
            ...
            <div>
                <a href="/honeymoon-trips/himachal-honeymoon-5-days-4-nights-tour-package/"
                    data-discover="true">
                    <div class="relative">
                        <img src="https://cdn.enjoykarado.com/packages/671935cd52ca3.webp" alt="Himachal Honeymoon 5 Days 4 Nights Tour Package"
                            class="w-full aspect-[6/7] object-cover rounded-3xl mb-2">
                        <div class="absolute top-3 left-3 lg:top-2 lg:left-2 text-base lg:text-xs z-10 backdrop-blur">
                            <div class="flex gap-2 place-items-center bg-black/30 text-white px-2 py-1 rounded-3xl">
                                <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24"
                    ...
                    <div class="flex place-items-center mt-1 overflow-hidden h-14">
                        <h2 class="text-lg font-medium line-clamp-2">
                            Himachal Honeymoon 5 Days 4 Nights Tour Package
                        </h2>
                    </div>
                    <div class="flex place-items-center text-sm font-medium mt-1 text-gray-500">
                        <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 16 16"
            ...
            <div>
                <a href="/honeymoon-trips/kashmir-honeymoon-5-days-tour-package/" data-discover="true">
                    <div class="relative">
                        <img src="https://cdn.enjoykarado.com/packages/67433c7dd003e.webp" alt="Kashmir Honeymoon 5 Days Tour Package"
                            class="w-full aspect-[6/7] object-cover rounded-3xl mb-2">
                        <div class="absolute top-3 left-3 lg:top-2 lg:left-2 text-base lg:text-xs z-10 backdrop-blur">
                            <div class="flex gap-2 place-items-center bg-black/30 text-white px-2 py-1 rounded-3xl">
                                <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24"
                    ...
                    <div class="flex place-items-center mt-1 overflow-hidden h-14">
                        <h2 class="text-lg font-medium line-clamp-2">
                            Kashmir Honeymoon 5 Days Tour Package
                        </h2>
                    </div>
                    <div class="flex place-items-center text-sm font-medium mt-1 text-gray-500">
                        <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 16 16"
